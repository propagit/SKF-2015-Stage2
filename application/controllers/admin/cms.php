...
class Cms extends CI_Controller 
{
	...
	*/
	...
	function add_photo()
	{
		$this->check_authentication();
		$gid = $_POST['gallery_id'];		
		$config['upload_path'] = "/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid);
		...
		else
		{
			...
			if($gid != 4)
			{
				...
				$config = array();
				// Resize image
				$config['source_image'] = "/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/".$file_name;
				...
				unlink("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/".$file_name);
				rename("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/".$data['upload_data']['raw_name']."_thumb".$data['upload_data']['file_ext'],"/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/".$file_name);
				$this->image_lib->clear();
			    }	
			}
			// Thumbnail creation
			...
			$config['source_image'] = "/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/".$file_name;
			$config['create_thumb'] = TRUE;
			$config['new_image'] = "/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/thumbnails/".$file_name;
			$config['maintain_ratio'] = TRUE;
			$config['quality'] = 100;
			  if ($width < $height) 
			  {		
			...
			rename("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/thumbnails/".$data['upload_data']['raw_name']."_thumb".$data['upload_data']['file_ext'],"/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/thumbnails/".$file_name);
			$this->image_lib->clear();
			
			// Crop thumbnail			
			$config['image_library'] = 'GD2';
			$config['source_image'] = "/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/thumbnails/".$file_name;
			...
			unlink("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/thumbnails/".$file_name);
			rename("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/thumbnails/".$data['upload_data']['raw_name']."_thumb".$data['upload_data']['file_ext'],"/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5('cdkgallery'.$gid)."/thumbnails/".$file_name);
	...
	function delete_gallery($id) 
	{
		...
		foreach($photos as $photo) {
			if ($this->Gallery_model->delete_photo($photo['id'])) {
				unlink("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5("cdkgallery".$id)."/".$photo['name']);
				unlink("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5("cdkgallery".$id)."/thumbnails/".$photo['name']);				
			}
		}
		//print_r('test');
		unlink("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5("cdkgallery".$id)."/index.html");
		unlink("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5("cdkgallery".$id)."/thumbnails/index.html");
		
		if ($this->Gallery_model->delete_gallery($id)) {
			rmdir("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5("cdkgallery".$id)."/thumbnails");
			rmdir("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5("cdkgallery".$id));
	...
	function delete_photo($id) 
	{
		...
		else
		{
			if ($this->Gallery_model->delete_photo($id)) 
			{
				...
				unlink("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5("cdkgallery".$photo['gallery_id'])."/".$photo['name']);
				unlink("/home/stkildaf/public_html/2015-s2/uploads/galleries/".md5("cdkgallery".$photo['gallery_id'])."/thumbnails/".$photo['name']);
    ...
    function deletenews($id)
    {
		...
		//if($news['media1']){unlink("/home/stkildaf/public_html/2015-s2/uploads/news/".$news['media1']);}
		//if($news['media2']){unlink("/home/stkildaf/public_html/2015-s2/uploads/news/".$news['media2']);}
	...
	function delete_image($id) 
	{
		...
		if ($news=$this->Menu_model->getnews($id)) {
			unlink("/home/stkildaf/public_html/2015-s2/uploads/news/".$news['media1']);
			$data=array(				
				'media1' => '',				
				'modified' => date('Y-m-d H:i:s') 
			);
	...
	function delete_image2($id) 
	{
		$this->check_authentication();
		if ($news=$this->Menu_model->getnews($id)) {
			unlink("/home/stkildaf/public_html/2015-s2/uploads/news/".$news['media2']);
			$data=array(				
				'media2' => '',				
				'modified' => date('Y-m-d H:i:s') 
			);
	...
	function delete_band($id=null)
	{
		...
		if($this->Music_band_model->delete_band($band['id']))
		{
			...
			$folder = md5('band'.$id);
	        delete_files('/home/stkildaf/public_html/2015-s2/uploads/bands/'.$folder, TRUE);
		    print 'Ok';
		}
		else
		{
	...
	function update_band_photo()
	{
		...
		$id = $_POST['band_id'];
		$dir = md5("band".$id);
	    $path = "/home/stkildaf/public_html/2015-s2/uploads/bands/".$dir."/";	
		$config['upload_path'] = $path;
		$config['allowed_types'] = 'gif|jpg|png';
		$config['max_size']	= '4096'; // 4 MB
		$config['max_width']  = '2000';
	...
	function update_band_music()
	{
		...
		$id = $_POST['band_id'];
		 $dir = md5("band".$id);
		$path = "/home/stkildaf/public_html/2015-s2/uploads/bands/".$dir."/music";	
		$config['upload_path'] = $path;
	  ...
	  else
	  {
		...
		{
			$xmlFile = "/home/stkildaf/public_html/2015-s2/uploads/bands/".$dir."/music/music.xml";
		...
		{
			$xmlFile = "/home/stkildaf/public_html/2015-s2/uploads/bands/".$dir."/music/music2.xml";
					    $fh = fopen($xmlFile,'w') or die("Couldn't open file to write");
						fwrite($fh,"<?xml version=\"1.0\" encoding=\"utf-8\"?>\n");
		                fwrite($fh,"<songs>\n");
	...
	function adding_band()
	{
		...
		$path = "/home/stkildaf/public_html/2015-s2/uploads/bands";
