             	...
             	<div class="row-fluid">            
               		<div class="span6">
                    	<p class="heading_content_page"><?php echo $band['band_name']?></p>
                 		<p class="subheading_content_page" style="margin-top:10px"><?php echo date('l d, M Y',strtotime($band['event_date']));?></p>
                        ...
                        <div id="band_social">
					   		<?php if($band['facebook'] != '') { ?><div id="facebook_icon" class="social-link" style="float:left;"><span>Facebook</span><a class="social-a" href="http://<?php echo $band['facebook'] ; ?>" target="_blank"><i style="color:#64d7c3" class="icon-facebook social-logo" ></i></a></div><?php } ?>
                       		<?php if($band['twitter'] != '') { ?><div id="twitter_icon" class="social-link" style="margin-left:30px;float:left;"><span>Twitter</span><a class="social-a" href="https://<?php echo $band['twitter'] ; ?>" target="_blank"><i style="color:#64d7c3" class="icon-twitter social-logo"></i></a></div><?php } ?>
                        	<?php if($band['youtube_channel'] != '') { ?><div id="youtube_icon" class="social-link" style="margin-left:30px;float:left;"><span>Youtube</span><a class="social-a" href="http://<?php echo $band['youtube_channel'] ; ?>" target="_blank"><i style="color:#64d7c3" class="icon-youtube social-logo"></i></a></div><?php } ?>
                        	<?php if($band['myspace'] != '') { ?><div id="myspace_icon" class="social-link" style="margin-left:30px;float:left;"><span>My Space</span><a class="social-a" href="http://<?php echo $band['myspace'] ; ?>" target="_blank"><img src="<?=base_url()?>images/myspace.png" alt="myspace" /></a></div><?php } ?>
                        	<?php if($band['reverbnation'] != '') { ?><div id="soundcloud_icon" class="social-link" style="margin-left:30px;float:left;"><span>Sound Cloud</span><a class="social-a" href="http://<?php echo $band['reverbnation'] ; ?>" target="_blank"><img src="<?=base_url()?>images/soundCloud.png" alt="" /></a></div><?php } ?>
                        	<?php if($band['bandcamp'] != '') { ?><div id="other_icon" class="social-link" style="margin-left:30px;float:left;"><span>Band Camp</span><a class="social-a" href="http://<?php echo $band['bandcamp'] ; ?>" target="_blank"><img src="<?=base_url()?>images/other.png" alt="" /></a></div><?php } ?>
                     	</div>
