			...
			<div class="span8">
             	...
             	<div class="row-fluid">            
               		<div class="span6">
                        ...
                        <div id="band_social">
					   		<?php if($band['facebook'] != '') { ?><div id="facebook_icon" class="social-link" style="float:left;"><span>Facebook</span><a class="social-a" href="http://<?php echo trim($band['facebook']) ; ?>" target="_blank"><i  class="fa fa-facebook social-logo" ></i></a></div><?php } ?>
                       		<?php if($band['twitter'] != '') { ?><div id="twitter_icon" class="social-link" style="margin-left:30px;float:left;"><span>Twitter</span><a class="social-a" href="https://<?php echo trim($band['twitter']) ; ?>" target="_blank"><i class="fa fa-twitter social-logo"></i></a></div><?php } ?>
                        	<?php if($band['youtube_channel'] != '') { ?><div id="youtube_icon" class="social-link" style="margin-left:30px;float:left;"><span>Youtube</span><a class="social-a" href="http://<?php echo trim($band['youtube_channel']) ; ?>" target="_blank"><i class="fa fa-youtube social-logo"></i></a></div><?php } ?>
                        	<?php if($band['myspace'] != '') { ?><div id="myspace_icon" class="social-link" style="margin-left:30px;float:left;"><span>My Space</span><a class="social-a" href="http://<?php echo trim($band['myspace']) ; ?>" target="_blank"><img src="<?=base_url()?>images/myspace.png" alt="myspace" /></a></div><?php } ?>
                        	<?php if($band['reverbnation'] != '') { ?><div id="soundcloud_icon" class="social-link" style="margin-left:30px;float:left;"><span>Sound Cloud</span><a class="social-a" href="http://<?php echo trim($band['reverbnation']) ; ?>" target="_blank"><i class="fa fa-soundcloud social-logo"></i></a></div><?php } ?>
                        	<?php if($band['bandcamp'] != '') { ?><div id="other_icon" class="social-link" style="margin-left:30px;float:left;"><span>Band Camp</span><a class="social-a" href="http://<?php echo trim($band['bandcamp']) ; ?>" target="_blank"><img src="<?=base_url()?>images/other.png" alt="" /></a></div><?php } ?>
                     	</div>
